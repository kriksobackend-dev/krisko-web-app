...
export function MobileBottomNav() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-20 border-t border-stone-100 bg-white/90 backdrop-blur-lg md:hidden">
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              `relative flex flex-col items-center gap-0.5 py-2 text-[10px] font-medium transition-colors ${
                isActive ? "text-krikso-600" : "text-stone-400"
              }`
            }
          >
